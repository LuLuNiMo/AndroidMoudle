...
public class MoudleInfos {
    ...
    //Progress 漸層 代碼
    public final static int Progress_Blue= R.drawable.pgc_blue;
    public final static int Progress_Pick= R.drawable.pgc_pick;
    public final static int Progress_Green= R.drawable.pgc_green;
